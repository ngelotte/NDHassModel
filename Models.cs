...
namespace NdGreenhouse.Apps.Greenhouse
{
    ...
    public class GHMain
    {
        ...
        private double? TryAndGetValue(SensorEntity sensorEntity)
        {
            ...
            {
                if (double.TryParse(sensorEntity.State, out double result))
                {
                    return result;
                }
            }
    ...
    public class GhConfig
    {
        ...
        public GHMain GhMain()
        {
            ...
            gHMain.Dehumidfier = new(_app, "switch.tb4p2");
            gHMain.SwampCooler = new(_app, "switch.st4p3");
            ...
            gHMain.InternalTempSensors.Add(new(_app, "sensor.ble_temperature_gh_indoor_temp"));
            gHMain.InternalTempSensors.Add(new(_app, "sensor.gh_interal_protected_temp"));
            gHMain.ExternalTempSensors.Add(new(_app, "sensor.ble_temperature_gh_temp_external"));
            gHMain.ExternalTempSensors.Add(new(_app, "sensor.exterior_temperature"));
            gHMain.InternalHumidtySensors.Add(new(_app, "sensor.ble_humidity_gh_indoor_temp"));
            gHMain.InternalHumidtySensors.Add(new(_app, "sensor.gh_interal_protected_humidity"));
            gHMain.ExternalHumiditySensors.Add(new(_app, "sensor.ble_humidity_gh_external"));
            gHMain.ExternalHumiditySensors.Add(new(_app, "sensor.exterior_humidity"));
            gHMain.MainFan = new(_app, "switch.fan");
            gHMain.WaterTankRefill = new(_app, "switch.power_strip_ne_outlet_3");
            gHMain.LowFreshWaterTank = new(_app, "binary_sensor.fresh_water_empty");
            gHMain.MediumFreshWaterTank = new(_app, "binary_sensor.fresh_water_medium");
            gHMain.HighFreshWaterTank = new(_app, "binary_sensor.fresh_water_full");
            gHMain.LowSwampCoolerTank = new(_app, "binary_sensor.swp_res_empty");
